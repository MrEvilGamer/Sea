...
struct FCrewSessionTemplate : public FSessionTemplate
{
	...
	unsigned char                                      UnknownData_34[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct AAthenaGameState {
	...
	struct AReapersTributeShipEventService* ReapersTributeShipEventService; // 0x6b8(0x08)
	struct AProjectileService* ProjectileService; // 0x6c0(0x08)
	struct AProjectileHitRegService* ProjectileHitRegService; // 0x6c8(0x08)
	struct ULaunchableProjectileService* LaunchableProjectileService; // 0x6d0(0x08)
	struct UServerNotificationsService* ServerNotificationsService; // 0x6d8(0x08)
	struct AAIManagerService* AIManagerService; // 0x6e0(0x08)
	struct AAIEncounterService* AIEncounterService; // 0x6e8(0x08)
	struct AAIEncounterGenerationService* AIEncounterGenerationService; // 0x6f0(0x08)
	struct UEncounterService* EncounterService; // 0x6f8(0x08)
	struct UGameEventSchedulerService* GameEventSchedulerService; // 0x700(0x08)
	struct UGameEventsOnDemandAvailabilityService* GameEventsOnDemandAvailabilityService; // 0x708(0x08)
	struct AGameEventsOnDemandLoserTunnelService* GameEventsOnDemandLoserTunnelService; // 0x710(0x08)
	struct UHideoutService* HideoutService; // 0x718(0x08)
	struct UAthenaStreamedLevelService* StreamedLevelService; // 0x720(0x08)
	struct ULocationProviderService* LocationProviderService; // 0x728(0x08)
	struct AHoleService* HoleService; // 0x730(0x08)
	struct APlayerBuriedItemService* PlayerBuriedItemService; // 0x738(0x08)
	struct ULoadoutService* LoadoutService; // 0x740(0x08)
	struct UOcclusionService* OcclusionService; // 0x748(0x08)
	struct UPetsService* PetsService; // 0x750(0x08)
	struct UAthenaAITeamsService* AthenaAITeamsService; // 0x758(0x08)
	struct AAllianceService* AllianceService; // 0x760(0x08)
	struct UMaterialAccessibilityService* MaterialAccessibilityService; // 0x768(0x08)
	struct UNPCLoadedOnClientService* NPCLoadedOnClientService; // 0x770(0x08)
	struct AReapersMarkService* ReapersMarkService; // 0x778(0x08)
	struct AEmissaryLevelService* EmissaryLevelService; // 0x780(0x08)
	struct AFactionService* FactionService; // 0x788(0x08)
	struct ACampaignService* CampaignService; // 0x790(0x08)
	struct AStoryService* StoryService; // 0x798(0x08)
	struct AStorySpawnedActorsService* StorySpawnedActorsService; // 0x7a0(0x08)
	struct AStoryClaimedResourcesService* StoryClaimedResourcesService; // 0x7a8(0x08)
	struct UGlobalVoyageDirectorService* GlobalVoyageDirector; // 0x7b0(0x08)
	struct UUtilityVoyageService* UtilityVoyageService; // 0x7b8(0x08)
	struct AFlamesOfFateSettingsService* FlamesOfFateSettingsService; // 0x7c0(0x08)
	struct AServiceStatusNotificationsService* ServiceStatusNotificationsService; // 0x7c8(0x08)
	struct UMigrationService* MigrationService; // 0x7d0(0x08)
	struct UShipStockService* ShipStockService; // 0x7d8(0x08)
	struct AShroudBreakerService* ShroudBreakerService; // 0x7e0(0x08)
	struct UServerUpdateReportingService* ServerUpdateReportingService; // 0x7e8(0x08)
	struct AGenericMarkerService* GenericMarkerService; // 0x7f0(0x08)
	struct AMechanismsService* MechanismsService; // 0x7f8(0x08)
	struct UMerchantContractsService* MerchantContractsService; // 0x800(0x08)
	struct UShipFactory* ShipFactory; // 0x808(0x08)
	struct URewindPhysicsService* RewindPhysicsService; // 0x810(0x08)
	struct UNotificationMessagesDataAsset* NotificationMessagesDataAsset; // 0x818(0x08)
	struct AProjectileCooldownService* ProjectileCooldownService; // 0x820(0x08)
	struct UIslandReservationService* IslandReservationService; // 0x828(0x08)
	struct APortalService* PortalService; // 0x830(0x08)
	struct UMeshMemoryConstraintService* MeshMemoryConstraintService; // 0x838(0x08)
	struct ABootyStorageService* BootyStorageService; // 0x840(0x08)
	struct ALoadoutCostService* LoadoutCostService; // 0x848(0x08)
	struct ASpireService* SpireService; // 0x850(0x08)
	struct AFireworkService* FireworkService; // 0x858(0x08)
	struct AInvasionService* InvasionService; // 0x860(0x08)
	struct UAirGivingService* AirGivingService; // 0x868(0x08)
	struct UCutsceneService* CutsceneService; // 0x870(0x08)
	struct ACargoRunService* CargoRunService; // 0x878(0x08)
	struct ACommodityDemandService* CommodityDemandService; // 0x880(0x08)
	struct ADebugTeleportationDestinationService* DebugTeleportationDestinationService; // 0x888(0x08)
	struct ASeasonProgressionUIService* SeasonProgressionUIService; // 0x890(0x08)
	struct UTransientActorService* TransientActorService; // 0x898(0x08)
	struct ATunnelsOfTheDamnedService* TunnelsOfTheDamnedService; // 0x8a0(0x08)
	struct UWorldSequenceService* WorldSequenceService; // 0x8a8(0x08)
	struct UItemLifetimeManagerService* ItemLifetimeManagerService; // 0x8b0(0x08)
	struct AShipStorageJettisonService* ShipStorageJettisonService; // 0x8b8(0x08)
	struct ASeaFortsService* SeaFortsService; // 0x8c0(0x08)
	struct ACustomServerLocalisationService* CustomServerLocalisationService; // 0x8c8(0x08)
	struct ABeckonService* BeckonService; // 0x8d0(0x08)
	struct UVolcanoService* VolcanoService; // 0x8d8(0x08)
	struct UShipAnnouncementService* ShipAnnouncementService; // 0x8e0(0x08)
	struct AShipsLogService* ShipsLogService; // 0x8e8(0x08)
	struct UAsyncLoadingMonitoringService* AsyncLoadingMonitoringService; // 0x8f0(0x08)
	struct AActorOfInterestService* ActorOfInterestService; // 0x8f8(0x08)
	struct AEnemyAIOnShipService* EnemyAIOnShipService; // 0x900(0x08)
	struct AUserSettingsService* UserSettingsService; // 0x908(0x08)
	struct AGuildService* GuildService; // 0x910(0x08)
	struct UGuildChroniclesService* GuildChroniclesService; // 0x918(0x08)
	struct APlayerLootMarkerService* PlayerLootMarkerService; // 0x920(0x08)
	struct AInventoryPersistenceService* InventoryPersistenceService; // 0x928(0x08)
	struct AAdventureOnDemandService* AdventureOnDemandService; // 0x930(0x08)
	struct AScrambledNamesService* ScrambledNamesService; // 0x938(0x08)
	struct UExperienceService* ExperienceService; // 0x940(0x08)
	struct UQuestTableService* QuestTableService; // 0x948(0x08)
	struct ACompetitiveVoyagesService* CompetitiveVoyagesService; // 0x950(0x08)
...
struct UStorageContainerComponent {
	...
	struct FTransform InstanceTransform; // 0x120(0x30)
	...
	struct UWwiseEvent* AddItemSFX; // 0x250(0x08)
	struct UWwiseEvent* TakeItemSFX; // 0x258(0x08)
	struct UWwiseEvent* OpenContainerSFX; // 0x260(0x08)
	struct UWwiseEvent* BeginQuickGiveSFX; // 0x268(0x08)
	struct UWwiseEvent* EndQuickGiveSFX; // 0x270(0x08)
	struct UWwiseEvent* BeginQuickTakeSFX; // 0x278(0x08)
	struct UWwiseEvent* EndQuickTakeSFX; // 0x280(0x08)
	struct UStorageContainerContentTypeSelector* CrateFillerContainerSelector; // 0x288(0x08)
	struct UStorageContainerContentTypeSelector* StorageContainerSelector; // 0x290(0x08)
	char UnknownData_298[0x30]; // 0x298(0x30)
	struct UWwiseObjectPoolWrapper* SfxPool; // 0x2c8(0x08)
	char UnknownData_2D0[0x40]; // 0x2d0(0x40)
	bool ShowCapacityInDescription; // 0x310(0x01)
	char UnknownData_311[0x9f]; // 0x311(0x9f)
	struct UObject* Aggregator; // 0x3b0(0x08)
...
struct UAthenaCharacterMovementComponent {
	...
	struct UAthenaCharacterMovementUnderwater* UnderwaterMovement; // 0x680(0x08)
	...
	struct UCurveFloat* UnderwaterVelocityToAnglePitchProjectileHitVolume; // 0x708(0x08)
	struct UCurveFloat* UnderwaterVelocityToAngleRollProjectileHitVolume; // 0x710(0x08)
	struct UCurveFloat* UnderwaterVelocityToZOffsetProjectileHitVolume; // 0x718(0x08)
	struct UCurveFloat* OnLandVelocityToAnglePitchProjectileHitVolume; // 0x720(0x08)
	struct UCurveFloat* OnLandVelocityToXOffsetProjectileHitVolume; // 0x728(0x08)
	struct UCurveFloat* OnLandVelocityToYOffsetProjectileHitVolume; // 0x730(0x08)
	struct UCurveFloat* OnLandVelocityToZOffsetProjectileHitVolume; // 0x738(0x08)
	struct UCurveFloat* FallingVelocityToAnglePitchProjectileHitVolume; // 0x740(0x08)
	struct UCurveFloat* FallingVelocityToXOffsetProjectileHitVolume; // 0x748(0x08)
	struct UCurveFloat* FallingVelocityToZOffsetProjectileHitVolume; // 0x750(0x08)
...
struct FProjectileWeaponParameters {
	...
	struct UWwiseEvent* EndOfBulletsNotificationSfx; // 0x178(0x08)
...
struct UCookerComponent {
	...
	void OnRep_CookingState(struct FCookingClientRepresentation OldRepresentation); // Function Cooking.CookerComponent.OnRep_CookingState // Final|Native|Private|HasOutParms // @ game+0x3d52470
};
...
struct ASpyglass {
	...
	struct UInventoryItemComponent* InventoryItem; // 0x7f0(0x08)
	struct UUsableWieldableComponent* UsableWieldableComponent; // 0x7f8(0x08)
	struct UAimSensitivityComponent* AimSensitivityComponent; // 0x800(0x08)
	...
	struct UPostProcessComponent* PostProcessComponent; // 0x838(0x08)
	struct UCurveFloat* BlurCurve; // 0x840(0x08)
	char UnknownData_848[0x38]; // 0x848(0x38)
	struct UMaterialInstanceDynamic* DynamicMaterial; // 0x880(0x08)
	...
	struct UStaticMeshComponent* Glint; // 0x898(0x08)
	struct UMaterial* MaterialParent; // 0x8a0(0x08)
	struct UTexture2D* LensNormal; // 0x8a8(0x08)
	struct UTexture2D* LensMask; // 0x8b0(0x08)
	struct FLinearColor LensTint; // 0x8b8(0x10)
	char UnknownData_8C8[0x8]; // 0x8c8(0x08)

	void SpyGlassRaisedFirstPerson(bool IsRaised); // Function Athena.Spyglass.SpyGlassRaisedFirstPerson // Event|Protected|BlueprintEvent // @ game+0x1926af0
	void SetGlintOff(); // Function Athena.Spyglass.SetGlintOff // RequiredAPI|Native|Public|BlueprintCallable // @ game+0x133a090
	void ResetSpyglassEffects(); // Function Athena.Spyglass.ResetSpyglassEffects // Final|Native|Public|BlueprintCallable // @ game+0x13399c0
};
